...
class AssignmentsDueSoonCard extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        final activeAssignments = assignments.where((assignment) => assignment.status != AssignmentStatus.submitted && assignment.status != AssignmentStatus.graded).toList()..sort((a,b)=>a,dueDate.compareTo(b.dueDate));
                        ...
                        if (upcomingAssignments.isEmpty)
                            ...
                            ...upcomingAssignments.map(
                                (assignment) => ListTile(
                                    ...
                                    trailing: const Icons(Icons.chevron_right),
